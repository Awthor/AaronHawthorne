...
export default [
    ...
    {
      title: "Kodflix",
      description:"This project was my first introduction into React, JavaScript, HTML5, CSS3, React-Router, Props, GitHub and much more. This is my top 6 favourite films but please don't hate me if you don't agree haha.",
      moredescription:"The idea behind this application was to play around with Grid/flex and have some interaction with overlays and clicking through each individual movie poster that will give some information about that particular movie.",
      imageUrl:kodflix,
    ...
    {
      title: "Portfolio",
      description:"TThis is my portfolio, having codded other projects in CSS and HTML5 I decided I would look at React Bootstrap and Material UI for their components and play around with them. I have used their Cards, styles and App bar to kick off this portfolio",
      moredescription:" This portfolio is built using React and Material UI, I wanted to understand how Material UI works as a lot of my clients use it so when speaking with people I have an understanding of it.",      
      imageUrl:Portfolio,
    },   
  ];
